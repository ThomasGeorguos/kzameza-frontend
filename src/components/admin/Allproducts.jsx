...
import { Pencil, Trash2, Star, X, Loader2, Search } from "lucide-react";
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        <div className="relative w-full sm:w-64">
          <input
            ...
            className="w-full bg-white text-gray-800 placeholder-gray-400 text-sm rounded-xl px-4 py-2.5 pl-10 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-400 transition-all"
          />
